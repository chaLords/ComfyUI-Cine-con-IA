...
3. **Capacidades recalculadas** (`memory_planner.py`): 1.42 / 1.86 / 2.38 / 3.13 / 4.06.
   Son una definición de política —el preset de cada tarjeta usa ~63 % de su
   capacidad a la carga de referencia—, no una medición.
